...
public final class QueryUtils {
    ...
    private static List<Book> extractFeatureFromJson(String bookJSON) {
        ...
        // Create a String placeholder of Authors
        String[] authors = new String[0];
        // Create a String for an unavailable URL
        String previewLink = "Preview Link Unavailable";
        ...
        try {
            ...
            // For each books in the itemsArray, create a {@link Book} object
            for (int i = 0; i < itemsArray.length(); i++) {
                ...
                // Ensure the JSONObject associated with the key "volumeInfo" contains a
                // JSONArray associated with the key called "authors"
                if(volumeInfo.has("authors")) {
                    ...
                    for (int j = 0; j < authorsArray.length(); j++) {
                        // Retrieve book author(s)
                        authors[j] = (authorsArray.getString(j));
                    }
                } else {
                    // Add an unknown author to the array
                    authors[0] = "Author Unknown";
                }

                // Ensure the JSONObject associated with the key "volumeInfo" contains a
                // key called "previewLink"
                if(volumeInfo.has("previewLink")) {
                    // Retrieve book preview link
                    previewLink = volumeInfo.getString("previewLink");
                }

                // Create a new {@link Book} object with the title, author(s),
